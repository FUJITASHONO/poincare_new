class Comparison:
	def comparison(input_text,database,model,border):
		...
		#ストップワードの除去
		noun_list3=Preprocess.stop_word(noun_list2)
		#類似度が高い文章のインデックスを抜き出し
		most_sim_index=Most_similarity.most_similarity(noun_list3,database,model,border)
